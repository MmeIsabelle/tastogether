...
tastings = {
  ...
  beans: Tasting.create!(
    ...
    date: DateTime.new(2021, 9, 1, 19, 0, 0),
  ...
  gelato: Tasting.create!(
    ...
    date: DateTime.new(2021, 9, 1, 20, 0, 0),
  ...
  milk: Tasting.create!(
    ...
    date: DateTime.new(2021, 9, 8, 19, 30, 0),
  ...
  vintage: Tasting.create!(
    ...
    date: DateTime.new(2021, 9, 5, 19, 0, 0),
  ...
  pizza: Tasting.create!(
    ...
    date: DateTime.new(2021, 9, 6, 18, 0, 0),
